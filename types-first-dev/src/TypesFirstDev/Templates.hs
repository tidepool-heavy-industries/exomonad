...
-- | Template definitions for TDD graph nodes.
--
...
scaffoldCompiled = $(typedTemplateFile ''ScaffoldTemplateCtx "templates/scaffold.jinja")
...
tddWriteTestsCompiled = $(typedTemplateFile ''TDDWriteTestsTemplateCtx "templates/tdd-write-tests.jinja")
...
tddReviewImplCompiled = $(typedTemplateFile ''TDDReviewImplTemplateCtx "templates/tdd-review-impl.jinja")
...
implCompiled = $(typedTemplateFile ''ImplTemplateCtx "templates/impl.jinja")
...
mergerCompiled = $(typedTemplateFile ''MergerTemplateCtx "templates/merger.jinja")
...
rebaserCompiled = $(typedTemplateFile ''RebaserTemplateCtx "templates/rebaser.jinja")
