...
instance FromJSON McpJsonRpcRequest where
  parseJSON = withObject "McpJsonRpcRequest" $ \o -> McpJsonRpcRequest
    <$> o .:? "id"
    <*> o .: "method"
    <*> o .:? "params"
...
instance FromJSON McpInitializeParams where
  parseJSON = withObject "McpInitializeParams" $ \o -> McpInitializeParams
    <$> o .: "protocolVersion"
    <*> o .: "capabilities"
    <*> o .: "clientInfo"
...
instance FromJSON McpToolCallParams where
  parseJSON = withObject "McpToolCallParams" $ \o -> McpToolCallParams
    <$> o .: "name"
    <*> o .: "arguments"
