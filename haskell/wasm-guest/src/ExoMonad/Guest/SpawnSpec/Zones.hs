...
zoneDefaults RustCore = ZoneDefaults
...
zoneDefaults HaskellWasm = ZoneDefaults
...
zoneDefaults RustBinary = ZoneDefaults
...
zoneDefaults Justfile = ZoneDefaults
