...
data ErrorContext
  = ErrorContext {errorContextCommand :: Hs.Text,
...
instance (HsProtobuf.Message ErrorContext) where
  encodeMessage
    _
    ErrorContext {errorContextCommand, errorContextExitCode,
                  errorContextStderr, errorContextStdout, errorContextFilePath,
                 ...
                 (Hs.mappend
                    (HsProtobuf.encodeMessageField
                       ...
                       ((Hs.coerce @Hs.Text @(HsProtobuf.String Hs.Text))
                          errorContextCommand))
                    (HsProtobuf.encodeMessageField
                       (HsProtobuf.FieldNumber 2) errorContextExitCode))
                 (HsProtobuf.encodeMessageField
...
instance (HsJSONPB.FromJSON ErrorContext) where
  parseJSON = HsJSONPB.parseJSONPB
instance (HsJSONPB.ToSchema ErrorContext) where
  declareNamedSchema _
    = do let declare_command = HsJSONPB.declareSchemaRef
         errorContextCommand <- declare_command Proxy.Proxy
         let declare_exit_code = HsJSONPB.declareSchemaRef
         errorContextExitCode <- declare_exit_code Proxy.Proxy
         let declare_stderr = HsJSONPB.declareSchemaRef
         errorContextStderr <- declare_stderr Proxy.Proxy
         let declare_stdout = HsJSONPB.declareSchemaRef
         errorContextStdout <- declare_stdout Proxy.Proxy
         let declare_file_path = HsJSONPB.declareSchemaRef
         errorContextFilePath <- declare_file_path Proxy.Proxy
         let declare_working_dir = HsJSONPB.declareSchemaRef
         errorContextWorkingDir <- declare_working_dir Proxy.Proxy
         let _ = Hs.pure ErrorContext
                   <*>
                     ((HsProtobuf.coerceOver @(HsProtobuf.String Hs.Text) @Hs.Text)
                   ...
                   <*>
                     ((HsProtobuf.coerceOver @(HsProtobuf.String Hs.Text) @Hs.Text)
                        (HsJSONPB.asProxy declare_stdout))
                   <*>
                     ((HsProtobuf.coerceOver @(HsProtobuf.String Hs.Text) @Hs.Text)
                        (HsJSONPB.asProxy declare_file_path))
                   <*>
                     ((HsProtobuf.coerceOver @(HsProtobuf.String Hs.Text) @Hs.Text)
                        (HsJSONPB.asProxy declare_working_dir))
         Hs.return
           HsJSONPB.NamedSchema
             {HsJSONPB._namedSchemaName = Hs.Just "ErrorContext",
                                               ...
                                               HsJSONPB._schemaProperties = HsJSONPB.insOrdFromList
                                                                              [("command", 
                                                                               ...
                                                                               ("working_dir", 
                                                                                errorContextWorkingDir)]}}
data FfiError
  = FfiError {ffiErrorMessage :: Hs.Text,
...
instance (HsProtobuf.Message FfiError) where
  encodeMessage
    _
    FfiError {ffiErrorMessage, ffiErrorCode, ffiErrorContext,
              ffiErrorSuggestion}
    = Hs.mappend
        (Hs.mappend
           (Hs.mappend
              (HsProtobuf.encodeMessageField
                 ...
                 ((Hs.coerce @Hs.Text @(HsProtobuf.String Hs.Text))
                    ffiErrorMessage))
              (HsProtobuf.encodeMessageField
                 (HsProtobuf.FieldNumber 2) ffiErrorCode))
           (HsProtobuf.encodeMessageField
              (HsProtobuf.FieldNumber 3)
              ((Hs.coerce
...
instance (HsJSONPB.FromJSON FfiError) where
  parseJSON = HsJSONPB.parseJSONPB
instance (HsJSONPB.ToSchema FfiError) where
  declareNamedSchema _
    = do let declare_message = HsJSONPB.declareSchemaRef
         ffiErrorMessage <- declare_message Proxy.Proxy
         let declare_code = HsJSONPB.declareSchemaRef
         ffiErrorCode <- declare_code Proxy.Proxy
         let declare_context = HsJSONPB.declareSchemaRef
         ffiErrorContext <- declare_context Proxy.Proxy
         let declare_suggestion = HsJSONPB.declareSchemaRef
         ffiErrorSuggestion <- declare_suggestion Proxy.Proxy
         let _ = Hs.pure FfiError
                   <*>
                     ((HsProtobuf.coerceOver @(HsProtobuf.String Hs.Text) @Hs.Text)
                   ...
                   <*>
                     ((HsProtobuf.coerceOver
                         @(HsProtobuf.Nested Exomonad.Ffi.ErrorContext)
                         @(Hs.Maybe Exomonad.Ffi.ErrorContext))
                        (HsJSONPB.asProxy declare_context))
                   <*>
                     ((HsProtobuf.coerceOver @(HsProtobuf.String Hs.Text) @Hs.Text)
                        (HsJSONPB.asProxy declare_suggestion))
         Hs.return
           HsJSONPB.NamedSchema
             {HsJSONPB._namedSchemaName = Hs.Just "FfiError",
              HsJSONPB._namedSchemaSchema = Hs.mempty
                                              {HsJSONPB._schemaParamSchema = Hs.mempty
                                                                               {HsJSONPB._paramSchemaType = Hs.Just
                                                                                                              HsJSONPB.SwaggerObject},
                ...
                <*>
                  (let
                     parseResult parseObj
                       = Hs.msum
                           [Hs.Just Hs.. FfiResultResultSuccessPayload
...
instance (HsJSONPB.FromJSON FfiResult) where
  parseJSON = HsJSONPB.parseJSONPB
instance (HsJSONPB.ToSchema FfiResult) where
  declareNamedSchema _
    = do let declare_result = HsJSONPB.declareSchemaRef
         ffiResultResult <- declare_result Proxy.Proxy
         let _ = Hs.pure FfiResult <*> HsJSONPB.asProxy declare_result
         Hs.return
           HsJSONPB.NamedSchema
             {HsJSONPB._namedSchemaName = Hs.Just "FfiResult",
              HsJSONPB._namedSchemaSchema = Hs.mempty
                                              {HsJSONPB._schemaParamSchema = Hs.mempty
                                                                               {HsJSONPB._paramSchemaType = Hs.Just
                                                                                                              HsJSONPB.SwaggerObject},
...
instance (HsJSONPB.ToSchema FfiResultResult) where
  declareNamedSchema _
    = do let declare_success_payload = HsJSONPB.declareSchemaRef
         ffiResultResultSuccessPayload <- declare_success_payload
                                            Proxy.Proxy
         let _ = Hs.pure FfiResultResultSuccessPayload
                   <*>
                     ((HsProtobuf.coerceOver
                         @(HsProtobuf.Bytes Hs.ByteString) @Hs.ByteString)
                        (HsJSONPB.asProxy declare_success_payload))
         let declare_error = HsJSONPB.declareSchemaRef
         ffiResultResultError <- declare_error Proxy.Proxy
         let _ = Hs.pure FfiResultResultError
                   <*> HsJSONPB.asProxy declare_error
         Hs.return
           HsJSONPB.NamedSchema
             {HsJSONPB._namedSchemaName = Hs.Just "FfiResultResult",
              HsJSONPB._namedSchemaSchema = Hs.mempty
                                              {HsJSONPB._schemaParamSchema = Hs.mempty
                                                                               {HsJSONPB._paramSchemaType = Hs.Just
                                                                                                              HsJSONPB.SwaggerObject},
                                               HsJSONPB._schemaProperties = HsJSONPB.insOrdFromList
                                                                              [("success_payload", 
                                                                                ffiResultResultSuccessPayload),
                                                                               ("error", 
                                                                                ffiResultResultError)],
