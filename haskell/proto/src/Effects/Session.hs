...
import qualified Effects.Agent
...
data RegisterTeamRequest
  = RegisterTeamRequest {registerTeamRequestTeamName :: Hs.Text,
                         ...
                         registerTeamRequestAgentType :: (HsProtobuf.Enumerated Effects.Agent.AgentType),
                         registerTeamRequestModel :: Hs.Text}
  deriving (Hs.Show, Hs.Eq, Hs.Ord, Hs.Generic)
...
instance (HsProtobuf.Message RegisterTeamRequest) where
  encodeMessage
    ...
    RegisterTeamRequest {registerTeamRequestTeamName,
                         registerTeamRequestInboxName, registerTeamRequestAgentType,
                         registerTeamRequestModel}
    = Hs.mappend
        (Hs.mappend
           (Hs.mappend
              (HsProtobuf.encodeMessageField
           ...
           (HsProtobuf.encodeMessageField
              (HsProtobuf.FieldNumber 3) registerTeamRequestAgentType))
        (HsProtobuf.encodeMessageField
       ...
       HsProtobufAST.DotProtoField
         ...
         (HsProtobufAST.Prim
            (HsProtobufAST.Named
               (HsProtobufAST.Dots
                  (HsProtobufAST.Path
                     ("exomonad" Hs.:| ["effects", "agent", "AgentType"])))))
...
instance (HsJSONPB.ToJSONPB RegisterTeamRequest) where
  toJSONPB (RegisterTeamRequest f1 f2 f3 f4)
    = HsJSONPB.object
        ["team_name"
           .= ((Hs.coerce @Hs.Text @(HsProtobuf.String Hs.Text)) f1),
         "inbox_name"
         ...
         "agent_type" .= f3,
         "model" .= ((Hs.coerce @Hs.Text @(HsProtobuf.String Hs.Text)) f4)]
  toEncodingPB (RegisterTeamRequest f1 f2 f3 f4)
    = HsJSONPB.pairs
        ["team_name"
           .= ((Hs.coerce @Hs.Text @(HsProtobuf.String Hs.Text)) f1),
         "inbox_name"
