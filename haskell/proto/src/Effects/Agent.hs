...
data ShutdownByBranchRequest
  = ShutdownByBranchRequest
  { shutdownByBranchRequestBranchName :: Hs.Text,
    shutdownByBranchRequestRemoveWorktree :: Hs.Bool
  }
  deriving (Hs.Show, Hs.Eq, Hs.Ord, Hs.Generic)

instance (Hs.NFData ShutdownByBranchRequest)

instance (HsProtobuf.Named ShutdownByBranchRequest) where
  nameOf _ = Hs.fromString "ShutdownByBranchRequest"

instance (HsProtobuf.HasDefault ShutdownByBranchRequest)

instance (HsProtobuf.Message ShutdownByBranchRequest) where
  encodeMessage
    _
    ShutdownByBranchRequest
      { shutdownByBranchRequestBranchName,
        shutdownByBranchRequestRemoveWorktree
      } =
      Hs.mappend
        ( HsProtobuf.encodeMessageField
            (HsProtobuf.FieldNumber 1)
  ...
  decodeMessage _ =
    Hs.pure ShutdownByBranchRequest
      <*> ( (HsProtobuf.coerceOver @(HsProtobuf.String Hs.Text) @Hs.Text)
              ( HsProtobuf.at
                  HsProtobuf.decodeMessageField
                  (HsProtobuf.FieldNumber 1)
  ...
  dotProto _ =
    [ HsProtobufAST.DotProtoField
      ...
      HsProtobufAST.DotProtoField
        (HsProtobuf.FieldNumber 2)
        (HsProtobufAST.Prim HsProtobufAST.Bool)
        (HsProtobufAST.Single "remove_worktree")
        []
        ""
    ]

instance (HsJSONPB.ToJSONPB ShutdownByBranchRequest) where
  toJSONPB (ShutdownByBranchRequest f1 f2) =
    HsJSONPB.object
      [ "branch_name"
          .= ((Hs.coerce @Hs.Text @(HsProtobuf.String Hs.Text)) f1),
        "remove_worktree" .= f2
      ]
  toEncodingPB (ShutdownByBranchRequest f1 f2) =
    HsJSONPB.pairs
      [ "branch_name"
          .= ((Hs.coerce @Hs.Text @(HsProtobuf.String Hs.Text)) f1),
        "remove_worktree" .= f2
...
instance (HsJSONPB.FromJSONPB ShutdownByBranchRequest) where
  parseJSONPB =
    HsJSONPB.withObject
      "ShutdownByBranchRequest"
      ( \obj ->
...
instance (HsJSONPB.ToJSON ShutdownByBranchRequest) where
  toJSON = HsJSONPB.toAesonValue
  toEncoding = HsJSONPB.toAesonEncoding

instance (HsJSONPB.FromJSON ShutdownByBranchRequest) where
  parseJSON = HsJSONPB.parseJSONPB

newtype ShutdownByBranchResponse
  = ShutdownByBranchResponse {shutdownByBranchResponseAgentFound :: Hs.Bool}
  deriving (Hs.Show, Hs.Eq, Hs.Ord, Hs.Generic)

instance (Hs.NFData ShutdownByBranchResponse)

instance (HsProtobuf.Named ShutdownByBranchResponse) where
  nameOf _ = Hs.fromString "ShutdownByBranchResponse"

instance (HsProtobuf.HasDefault ShutdownByBranchResponse)

instance (HsProtobuf.Message ShutdownByBranchResponse) where
  encodeMessage
    _
    ShutdownByBranchResponse {shutdownByBranchResponseAgentFound} =
      ( HsProtobuf.encodeMessageField
          (HsProtobuf.FieldNumber 1)
          shutdownByBranchResponseAgentFound
      )
  decodeMessage _ =
    Hs.pure ShutdownByBranchResponse
      <*> HsProtobuf.at
        HsProtobuf.decodeMessageField
        (HsProtobuf.FieldNumber 1)
  dotProto _ =
    [ HsProtobufAST.DotProtoField
        (HsProtobuf.FieldNumber 1)
        (HsProtobufAST.Prim HsProtobufAST.Bool)
        (HsProtobufAST.Single "agent_found")
        []
        ""
    ]

instance (HsJSONPB.ToJSONPB ShutdownByBranchResponse) where
  toJSONPB (ShutdownByBranchResponse f1) =
    HsJSONPB.object ["agent_found" .= f1]
  toEncodingPB (ShutdownByBranchResponse f1) =
    HsJSONPB.pairs ["agent_found" .= f1]

instance (HsJSONPB.FromJSONPB ShutdownByBranchResponse) where
  parseJSONPB =
    HsJSONPB.withObject
      "ShutdownByBranchResponse"
      ( \obj ->
          Hs.pure ShutdownByBranchResponse <*> obj .: "agent_found"
      )

instance (HsJSONPB.ToJSON ShutdownByBranchResponse) where
  toJSON = HsJSONPB.toAesonValue
  toEncoding = HsJSONPB.toAesonEncoding

instance (HsJSONPB.FromJSON ShutdownByBranchResponse) where
  parseJSON = HsJSONPB.parseJSONPB
