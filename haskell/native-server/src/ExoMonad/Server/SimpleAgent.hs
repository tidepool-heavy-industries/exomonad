...
-- import ExoMonad.Server.EffectRunner (runEffects)
--
-- -- In WebSocket handler:
-- runEffects env ctx callback simpleAgent
-- @
module ExoMonad.Server.SimpleAgent
  ( simpleAgent
  ) where
...
import ExoMonad.Effects.UI (UI, showText, requestTextInput)
...
import ExoMonad.Effects.Observability (Observability, publishEvent, ExoMonadEvent(..))
