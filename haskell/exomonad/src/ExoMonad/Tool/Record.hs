...
import ExoMonad.Tool.Class (MCPCallOutput (..), MCPTool (..), ToolDefinition (..), errorResult)
import ExoMonad.Tool.Mode (AsHandler, AsSchema, Handler (..), Schema (..))
import GHC.Generics
