...
data GraphSpec = GraphSpec
  { -- | Short ID (e.g., "test", "example", "habitica")
    gsId :: Text,
    -- | Full graph name (e.g., "TestGraph")
    gsName :: Text,
    -- | Node names
    gsNodes :: [Text],
...
generatePackageJson name version =
  T.unlines
    [ "{",
      "  \"name\": " <> quote name <> ",",
