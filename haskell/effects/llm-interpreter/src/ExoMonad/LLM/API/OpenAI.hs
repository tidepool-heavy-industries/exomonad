...
--
-- @
-- import ExoMonad.LLM.API.OpenAI (openaiComplete, OpenAIRequest(..))
...
-- @
module ExoMonad.LLM.API.OpenAI
  ( -- * API Type
    OpenAIAPI
...
import ExoMonad.Effects.LLMProvider (OpenAIResponse(..), OpenAIConfig(..))
