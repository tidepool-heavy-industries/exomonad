# BD Interpreter - Beads Task Tracking Integration
...
```haskell
import Tidepool.BD.Interpreter (runBDIO, BDConfig(..))
...
| `GitInterpreter.hs` | Git operations for beads sync |
