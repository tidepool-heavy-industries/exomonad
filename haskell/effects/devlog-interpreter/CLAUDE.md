# DevLog Interpreter - Session-Scoped Agent Logging
...
| Module | Purpose |
|--------|---------|
| `Interpreter.hs` | Effect interpreter, file management |
...
- [effects/observability-interpreter/CLAUDE.md](../observability-interpreter/CLAUDE.md) - OTLP traces (external)
- [dsl/core/CLAUDE.md](../../dsl/core/CLAUDE.md) - Graph effects and annotations
