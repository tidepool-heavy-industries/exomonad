# Observability Executor - Grafana Loki & Tempo Integration
...
```haskell
import Tidepool.Observability.Executor (interposeWithLLMTracing)
...
| Module | Purpose |
|--------|---------|
| `Executor.hs` | Effect interpreter, HTTP clients |
