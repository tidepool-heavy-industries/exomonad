-- | UI effect interpreter - bridges UI effects to wire types.
--
...
--
-- @
-- import ExoMonad.UI.Interpreter (runUI, UICallback)
...
-- @
module ExoMonad.UI.Interpreter
  ( -- * Interpreter
    runUI
...
import ExoMonad.Effects.UI (UI(..), ChoiceMeta(..), ChoiceAvailability(..))
