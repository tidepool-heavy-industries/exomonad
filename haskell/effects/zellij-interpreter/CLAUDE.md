...
**Note:** KDL layouts are generated by `zellij-gen` (Rust binary) with baked-in environment variables and commands. See `rust/zellij-gen/CLAUDE.md` for layout generation details.
