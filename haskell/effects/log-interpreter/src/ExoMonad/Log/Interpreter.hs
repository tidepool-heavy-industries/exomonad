...
-- @
module ExoMonad.Log.Interpreter
  ( -- * Interpreter
    runLogFastLogger
  , withLogInterpreter
...
import ExoMonad.Effect.Log (Log(..), LogLevel(..), LogContext)
import ExoMonad.Log.Types
import ExoMonad.Log.Formatter
