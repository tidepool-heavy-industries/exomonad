...
--
-- The DevLog effect has been consolidated into 'Tidepool.Effect.Log'.
...
-- Before:
-- @
-- import Tidepool.Effect.DevLog (devLogGraph, GraphTransitionInfo(..))
-- devLogGraph GraphTransitionInfo { ... }
-- @
--
-- After:
-- @
-- import Tidepool.Effect.Log (logGraph, GraphTransitionInfo(..))
-- logGraph GraphTransitionInfo { ... }
-- @
--
-- The event types are now defined in 'Tidepool.Effect.Log'.
...
--
-- DEPRECATED: Use LogLevel from Tidepool.Effect.Log instead.
