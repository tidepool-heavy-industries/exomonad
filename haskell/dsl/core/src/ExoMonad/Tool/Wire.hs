...
-- For type-safe tool definitions with schemas, see 'ExoMonad.Graph.Tool.ToolDef'.
--
-- = See Also
--
-- * "ExoMonad.Graph.Tool" - The 'ToolDef' typeclass for defining tools
-- * "ExoMonad.Tool.Convert" - Conversion from 'ToolDef' to wire types
-- * "ExoMonad.Schema" - 'JSONSchema' type used by these wire formats
--
-- = Format Differences
--
-- __Anthropic__:
