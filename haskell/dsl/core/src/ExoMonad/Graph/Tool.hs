...
-- = See Also
--
-- * "ExoMonad.Tool.Wire" - Wire format types for Anthropic and OpenAI APIs
-- * "ExoMonad.Tool.Convert" - Conversion typeclasses ('ToAnthropicTool', 'ToCfTool')
-- * "ExoMonad.Schema" - JSON Schema derivation for tool input types
--
-- = Design Principle
--
