...
-- | Supported protocol versions (patched to support Claude Code)
-- 2024-11-05: Original Claude Code version
-- 2025-06-18: mcp-server library default
-- 2025-11-25: Claude Code 2.1.7 (current)
supportedVersions :: [Text]
supportedVersions = ["2024-11-05", "2025-06-18", "2025-11-25"]

-- | Validate protocol version and return negotiated version
-- Patched: accepts both 2024-11-05 (Claude Code) and 2025-06-18 (latest spec)
validateProtocolVersion :: Text -> Either Text Text
validateProtocolVersion clientVersion
  | clientVersion `elem` supportedVersions = Right clientVersion  -- Echo back client's version
  | otherwise = Left $ "Unsupported protocol version: " <> clientVersion <> ". Server supports: 2024-11-05, 2025-06-18"
