...
// `AgentType`, `ClaudeSpawnFlags`, and the launch-command builder moved to
// exomonad-shared; re-exported here so classic paths resolve unchanged.
pub use exomonad_shared::services::agent_control::{launch, AgentType, ClaudeSpawnFlags};
    ...
    > AgentControlService<C>
{
    ...
    pub(crate) fn effective_project_dir(
        &self,
        subrepo: Option<&Path>,
