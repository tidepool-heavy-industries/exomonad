...
7. Create Zellij tab: `zellij action new-tab --layout /tmp/exomonad-layouts/<name>.kdl` (where name is exactly the worktree name)
8. Tab auto-closes when agent exits (`close_on_exit true`)

**Cleanup flow:**
1. Close Zellij tab: `zellij action close-tab` (using full worktree name)
