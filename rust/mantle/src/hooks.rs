...
const TIDEPOOL_MARKER: &str = "_tidepool_generated";
...
fn is_tidepool_hook(entries: &Value) -> bool {
...
mod tests {
    ...
    fn test_is_tidepool_hook() {
        ...
        assert!(!is_tidepool_hook(&other_hook));
    }
}
