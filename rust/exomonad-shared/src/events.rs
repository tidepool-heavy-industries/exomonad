...
/// An interrupt signal sent by Claude via `exomonad signal`.
///
...
/// exomonad and Haskell for interpreting exit codes. The Haskell orchestrator
...
// ============================================================================
// Output Types (what exomonad returns to callers)
// ============================================================================

/// The final result returned by exomonad to the Haskell orchestrator.
#[derive(Serialize, Deserialize, Debug, Clone)]
