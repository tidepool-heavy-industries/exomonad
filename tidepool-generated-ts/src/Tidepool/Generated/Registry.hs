...
-- are defined in tidepool-wasm to avoid circular dependencies.
--
-- = Usage
--
-- In tidepool-wasm, define your registry and instances:
--
-- @
...
-- @
module Tidepool.Generated.Registry
  ( -- * Metadata Typeclass
    GraphMeta(..)
...
-- separately in tidepool-wasm to avoid circular dependencies.
