...
-- Output:
--
-- > import type { GraphId } from './graphs';
-- > import type { GraphWasmExports } from './exports';
-- >
...
generateIndexTs = T.unlines
  ...
  , ""
  , "// Graph metadata"
  , "export type { GraphId, GraphInfo, GraphEdge } from './graphs';"
  , "export { graphRegistry } from './graphs';"
  , ""
  , "// WASM exports interface"
  , "export type { GraphWasmExports } from './exports';"
  , ""
  , "// Type-safe dispatcher"
  , "export type { GraphFns } from './dispatcher';"
  , "export { getGraphFns } from './dispatcher';"
  , ""
  , "// Protocol types"
