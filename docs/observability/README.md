...
This directory documents the observability infrastructure for Tidepool, powered by OpenObserve.

## Architecture

Tidepool uses a dual-storage approach for observability:
...
3.  Access the Web UI:
    ...
    - Email: `admin@tidepool.local`
    - Password: `tidepool-dev`
