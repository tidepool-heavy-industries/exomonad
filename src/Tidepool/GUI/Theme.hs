...
themeToCSS theme = T.unlines
  ...
  , "}"
  , ""
  , "/* OUTCOME: Dice result - most important post-roll info */"
  , ".state-event-outcome {"
  , "  border-left-width: 5px;"
  , "  padding: 14px 18px;"
  , "  margin: 16px 0;"
  , "}"
  , ""
  , ".state-event-outcome .state-event-label {"
  , "  font-size: 14px;"
  , "  letter-spacing: 2px;"
  , "  margin-bottom: 8px;"
  , "}"
  , ""
  , ".state-event-outcome .state-event-content {"
  , "  font-size: 14px;"
  , "  font-style: italic;"
  , "  line-height: 1.6;"
  , "}"
  ...
  , ".state-event-positive.state-event-outcome {"
  , "  border-left-color: var(--critical);"
  , "  background: linear-gradient(90deg, rgba(201, 162, 39, 0.25) 0%, var(--bg-secondary) 100%);"
  , "}"
  , ""
  , ".state-event-positive.state-event-outcome .state-event-label {"
  , "  color: var(--critical);"
  , "}"
  ]
  where
